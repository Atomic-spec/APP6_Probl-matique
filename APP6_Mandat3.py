...
Lm = 0.24055
FP = 1
IB3= 516                              #Ampère, vient de la simulation
...
M3 = np.dot(M1,MP)
#M3 = np.dot(M2,MC)
print("La matrice Alternateur est:\n",MA,"\n")
print("La matrice T est:\n",MT,"\n")
print("La matrice P est:\n",MP,"\n")
...
print("On met P = SIL", Sil/3)
print("le code trouve:",sol)
print(0.8*Sil)
print("Les matrices utilisés sont:\t",bb,"\t",cc,"\t",dd, "\t",ee)
if not sol:
    print("No solution")
else:
